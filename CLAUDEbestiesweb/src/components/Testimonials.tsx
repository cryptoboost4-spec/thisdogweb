            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {TESTIMONIALS_DATA.map((testimonial, index) => (
                        ...
                        >
                            {/* Quote decoration */}
                            <div className="absolute top-2 left-3 text-5xl sm:text-6xl text-primary/10 font-display leading-none">
                                "
                            </div>
                            <div className="relative z-10">
                                ...
                                <div className="flex items-center gap-2 sm:gap-3">
                                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center text-white font-display text-sm sm:text-base shadow-soft group-hover:scale-110 transition-transform duration-200">
